...
export default function ScanReportDetail() {
    ...
    if (loading) return <div className="min-h-screen bg-gray-950 text-white flex items-center justify-center">Loading Report...</div>;
    if (!scan) return <div className="min-h-screen bg-gray-950 text-white flex items-center justify-center">Report not found</div>;
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 font-sans">
            {/* 1. Report Header */}
            <header className="bg-gray-100 border-b border-gray-300 p-8 print:p-0">
                <div className="max-w-5xl mx-auto">
                    <div className="flex justify-between items-start mb-6">
                        ...
                        <div className="text-right hidden md:block">
                            <h1 className="text-2xl font-bold text-gray-800">Domain Security Scan Report</h1>
                            <p className="text-sm text-gray-500">Confidential & Proprietary</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-2">
                            <div className="flex justify-between border-b border-gray-300 py-1">
                                <span className="font-semibold text-gray-600">Target Domain:</span>
                            ...
                            <div className="flex justify-between border-b border-gray-300 py-1">
                                <span className="font-semibold text-gray-600">Scan Date:</span>
                                <span>{new Date(scan.startedAt).toLocaleString()}</span>
                            </div>
                            <div className="flex justify-between border-b border-gray-300 py-1">
                                <span className="font-semibold text-gray-600">Scan Type:</span>
                        ...
                        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm flex flex-col items-center justify-center">
                            <h3 className="text-gray-500 font-medium uppercase tracking-wider text-sm mb-2">Overall Status</h3>
            ...
            <main className="max-w-5xl mx-auto p-8 space-y-12">
                ...
                {/* 2. Executive Summary */}
                <section>
                    <h2 className="text-xl font-bold border-b-2 border-blue-600 pb-2 mb-6">2. Executive Summary</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="col-span-2">
                            ...
                            <div className="mt-4 p-4 bg-blue-50 border-l-4 border-blue-500 text-blue-800 text-sm">
                ...
                {/* 3. Scope */}
                <section>
                    <h2 className="text-xl font-bold border-b-2 border-blue-600 pb-2 mb-6">3. Scan Scope & Methodology</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                ...
                <section>
                    <h2 className="text-xl font-bold border-b-2 border-blue-600 pb-2 mb-6">4. Domain & Infrastructure Overview</h2>
                    <table className="w-full text-sm border border-gray-200">
                        <tbody>
                            <tr className="border-b">
                                <td className="p-3 bg-gray-50 font-semibold w-1/3">Domain Name</td>
                                <td className="p-3">{scan.domain?.domain}</td>
                            </tr>
                            <tr className="border-b">
                                <td className="p-3 bg-gray-50 font-semibold">SSL Status</td>
                                <td className="p-3">
                            ...
                            <tr className="border-b">
                                <td className="p-3 bg-gray-50 font-semibold">Open Ports</td>
                ...
                {/* 6. Detailed Findings */}
                <section>
                    <h2 className="text-xl font-bold border-b-2 border-blue-600 pb-2 mb-6">6. Detailed Findings</h2>

                    {enrichedFindings.length === 0 ? (
                        <p className="text-gray-500 italic">No security findings were detected during this scan.</p>
                    ) : (
                        <div className="space-y-8">
                            {enrichedFindings.map((finding: any, idx: number) => (
                                <div key={idx} className="border border-gray-300 rounded-lg overflow-hidden">
                                    <div className={`p-4 border-b border-gray-300 flex justify-between items-center ${finding.severity === 'critical' ? 'bg-red-50' :
                                            finding.severity === 'high' ? 'bg-orange-50' : 'bg-yellow-50'
                                        }`}>
                                        ...
                                        <span className="uppercase font-bold text-xs tracking-wider border border-gray-400 px-2 py-1 rounded bg-white">
                                            {finding.severity}
                                        </span>
                                    </div>
                                    <div className="p-6 space-y-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900 mb-1">Why This Matters</h4>
                                            <p className="text-gray-700 text-sm leading-relaxed">{finding.why}</p>
                                        </div>

                                        <div className="bg-gray-50 p-4 border-l-4 border-green-500">
                                            <h4 className="font-bold text-green-800 mb-1">Recommendation</h4>
                                            <p className="text-green-900 text-sm">{finding.rec}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
                ...
                {/* 10. Disclaimer */}
                <section className="bg-gray-50 p-8 border-t-2 border-gray-200 mt-12 text-sm text-gray-500 text-justify">
                    <h4 className="font-bold text-gray-700 mb-2 uppercase flex items-center gap-2"><Shield className="w-4 h-4" /> Disclaimer</h4>
                    <p>
                ...
                <footer className="text-center pt-8 border-t border-gray-200">
                    <p className="font-semibold text-gray-800">AlertMatrix Security</p>
                    <p className="text-sm text-blue-600">support@alertmatrix.in | alertmatrix.in</p>
                </footer>
            </main>
        </div>
    );
